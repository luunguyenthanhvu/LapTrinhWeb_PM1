    ...
    <form action="account" method="post">
      ...
      <div class="user__info">
        <div class="date_of_birth">
          ...
          <div class="input__field">
            <input name="day" type="text" class="day" placeholder="DD">
            <input name="month" type="text" class="month" placeholder="MM">
            <input name="year" type="text" class="year" placeholder="YYYY">
          </div>
        </div>
        <div class="gender">
          <div class="header__tag">
        ...
        <div class="payment__info">
          ...
          <div class="card__info">
            <div class="input__field">
              ...
              <div class="input__text">
                <input name="card_cvc" id="card_cvc" type="text" placeholder="Card CVC">
              </div>
            </div>
