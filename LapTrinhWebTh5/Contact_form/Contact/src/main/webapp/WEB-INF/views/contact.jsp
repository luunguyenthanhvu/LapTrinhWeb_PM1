...
<head>
    ...
    <meta charset="UTF-8">
    <link rel="stylesheet" href="<c:url value="/static/css/stylee.css"/>">
    <title>Title</title>
</head>
<body>
<div class="container">
        ...
        <form action="contact" method="post">
            ...
            <div class="flex__container">
                ...
                <div class="input_flex_two_child">
                    ...
                    <input name="phone" id="phone" type="text" placeholder="Enter Number Phone">
                </div>
            </div>
            <p class="error" id="email_error"></p>
            <div class="input__value">
                <label for="needed_services">NEEDED SERVICES*</label> <br>
                <select id="needed_services" name="service">
            ...
            <div class="input__value">
                ...
                <textarea name="message" id="message" class="textarea__message" placeholder="Your message here"></textarea>
            </div>
